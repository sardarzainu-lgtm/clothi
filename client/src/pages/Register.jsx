...
const Register = () => {
    ...
    // Set body background to match footer to eliminate white space below footer
    useEffect(() => {
        const originalBodyBackground = window.getComputedStyle(document.body).background;
        const originalBodyBackgroundImage = window.getComputedStyle(document.body).backgroundImage;
        
        // Match footer background exactly: linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #0f172a 100%)
        // Use setProperty with !important to override CSS
        document.body.style.setProperty('background', 'linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #0f172a 100%)', 'important');
    ...
    return (
        <>
            {/* Fixed background overlay to cover white space below footer */}
            <div style={{
                position: 'fixed',
                bottom: 0,
                left: 0,
            ...
            {isLoading && (
                <div style={{
                    ...
                    <div style={{
                        ...
                        width: '400px',
                        height: '400px',
                        background: 'radial-gradient(circle, rgba(210, 168, 65, 0.2) 0%, transparent 70%)',
                        borderRadius: '50%',
                    ...
                    <div style={{
                        ...
                        width: '300px',
                        height: '300px',
                        background: 'radial-gradient(circle, rgba(244, 222, 133, 0.15) 0%, transparent 70%)',
                        borderRadius: '50%',
                    ...
                    <div style={{
                        ...
                        <div style={{
                            width: '100px',
                            height: '100px',
                            border: '5px solid rgba(210, 168, 65, 0.2)',
                            borderTop: '5px solid #d2a841',
                            borderRight: '5px solid #deb94f',
                            borderRadius: '50%',
                            animation: 'spin 1s linear infinite',
                            boxShadow: '0 0 40px rgba(210, 168, 65, 0.6), 0 0 80px rgba(244, 222, 133, 0.4)',
                            position: 'relative'
                        }}>
                            <div style={{
                                position: 'absolute',
                                ...
                                width: '70px',
                                height: '70px',
                                border: '4px solid rgba(244, 222, 133, 0.3)',
                                borderTop: '4px solid #f4de85',
                                borderRadius: '50%',
                            ...
                            <div style={{
                                ...
                                width: '40px',
                                height: '40px',
                                border: '3px solid rgba(210, 168, 65, 0.4)',
                                borderTop: '3px solid #deb94f',
                                borderRadius: '50%',
                    ...
                    <div style={{
                        ...
                        <h2 style={{
                            ...
                            textShadow: '0 0 40px rgba(210, 168, 65, 0.4)'
                        }}>
            ...
            <div className="fade-in register-form-container" style={{
                width: '100%',
                maxWidth: '520px',
                position: 'relative',
                zIndex: 1
                ...
                <div className="register-form-card" style={{
                    ...
                    {/* Header */}
                    <div className="register-header" style={{ textAlign: 'center', marginBottom: '3rem', position: 'relative', zIndex: 2 }}>
                        <h1 style={{
                            fontSize: '2.75rem',
                            fontWeight: '800',
                        ...
                        <div style={{ marginBottom: '1.75rem' }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                <FaUser style={{
                                    ...
                                    color: isFocused.name ? '#f4de85' : 'rgba(255, 255, 255, 0.5)',
                                    fontSize: '1.1rem',
                                    transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                                    pointerEvents: 'none',
                                    zIndex: 1,
                                    filter: isFocused.name ? 'drop-shadow(0 0 8px rgba(244, 222, 133, 0.6))' : 'none'
                                }} />
                                <input
                                    type="text"
                                    value={name}
                                    ...
                                    onBlur={() => setIsFocused({ ...isFocused, name: name.length > 0 })}
                                    ...
                                    style={{
                                        ...
                                        fontSize: '1rem',
                                        border: `2px solid ${isFocused.name ? 'rgba(244, 222, 133, 0.6)' : 'rgba(255, 255, 255, 0.15)'}`,
                                        borderRadius: '16px',
                        ...
                        <div style={{ marginBottom: '2.5rem' }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                <FaLock style={{
                                    ...
                                    top: '50%',
                                    transform: 'translateY(-50%)',
                                    color: isFocused.confirmPassword ? '#f4de85' : 'rgba(255, 255, 255, 0.5)',
                                    fontSize: '1.1rem',
                                    transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                                    pointerEvents: 'none',
                                    zIndex: 1,
                                    filter: isFocused.confirmPassword ? 'drop-shadow(0 0 8px rgba(244, 222, 133, 0.6))' : 'none'
                                }} />
                                <input
                                    ...
                                    onBlur={() => setIsFocused({ ...isFocused, confirmPassword: confirmPassword.length > 0 })}
                                    ...
                                    style={{
                                        ...
                                        paddingRight: '3.5rem',
                                        fontSize: '1rem',
                                        border: `2px solid ${isFocused.confirmPassword ? 'rgba(244, 222, 133, 0.6)' : 'rgba(255, 255, 255, 0.15)'}`,
                                        borderRadius: '16px',
                                        background: 'rgba(255, 255, 255, 0.1)',
                                        backdropFilter: 'blur(10px)',
                                        color: '#ffffff',
                        ...
                        <button
                            ...
                            style={{
                                ...
                                background: isLoading 
                                    ? 'linear-gradient(135deg, rgba(210, 168, 65, 0.6) 0%, rgba(222, 185, 79, 0.6) 25%, rgba(244, 222, 133, 0.6) 50%, rgba(222, 185, 79, 0.6) 75%, rgba(210, 168, 65, 0.6) 100%)'
                                    : 'linear-gradient(135deg, #d2a841 0%, #deb94f 25%, #f4de85 50%, #deb94f 75%, #d2a841 100%)',
                                backgroundSize: '200% 100%',
                                border: 'none',
                                borderRadius: '16px',
                                color: '#ffffff',
                                ...
                                transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                                boxShadow: isLoading
                                    ? '0 4px 12px rgba(210, 168, 65, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.2)'
                                    : '0 8px 24px rgba(210, 168, 65, 0.4), 0 4px 12px rgba(210, 168, 65, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.3)',
                                position: 'relative',
                                overflow: 'hidden',
